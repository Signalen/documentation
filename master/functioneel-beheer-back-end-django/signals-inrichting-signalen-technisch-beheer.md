...
<table><thead><tr><th width="167">Type</th><th>Voorbeeld JSON</th></tr></thead><tbody><tr><td>PlainText</td><td><em>Citation</em>:<br>{"type": "citation", "label": "Voorbeeld Citation. Voor meer informatie, kijk op onze website [link-naam](URL)!"}<br><br><em>Alert</em>:<br>{"type": "alert", "value": "Wilt u ons tijdens kantoortijden bellen op 073 - 615 55 55? Zo kunt u ons helpen het probleem sneller of beter op te lossen."}<br><br><em>Caution</em>:<br>{"type": "caution", "label": "We mailen om u te vertellen wat we met uw melding doen en wanneer het klaar is."}<br><br><em>Harde stop</em>:<br>{"type": "alert", "value": "Dit is een voorbeeld van een harde stop. U kunt dit formulier niet meer verder invullen.", "ifOneOf": {"naam vragenlijst": ["3"]}, "validators": ["isBlocking"]}<br><br><em>Na het invullen van een antwoord</em>:<br>{"type": "alert", "value": "Huurt u een woning? Neem dan contact op met de woningbouwvereniging of verhuurder. Zij helpen u verder.", "ifOneOf": {"naam_vragenlijst": "1"}}</td></tr><tr><td>TextInput</td><td>{"type": "email", "label": "Wat is uw e-mailadres?", "subtitle": "We mailen om u te vertellen wat we met uw melding doen en wanneer het klaar is.", "shortLabel": "E-mail", "validators": ["email", ["max_length", 9]], "placeholder": "jan@jansen.nl"}</td></tr><tr><td>SelectInput</td><td>Werkt niet</td></tr><tr><td>RadioInput</td><td>{"label": "Uw melding gaat over:", "values": {"1": "Horeca (café, restaurant, kantine etc.)", "2": "Bedrijf (winkel, supermarkt, sportschool etc.)", "3": "Evenement (festival, feest, markt etc.)", "4": "Iets anders"}}</td></tr><tr><td>CheckboxInput</td><td>{"label": "Gaat het om een evenement?", "values": {"1": "Ja", "2": "Nee", "3": "Weet ik niet/Anders"}}</td></tr><tr><td>AssetSelect</td><td>{"label": "Selecteer het lichtpunt waar het om gaat", "endpoint": "[URL]", "language": {"title": "Kies het lichtpunt", "subTitle": "U kunt maar één lichtpunt kiezen", "submitPlural": "Meld deze lichtpunten", "unregistered": "Het lichtpunt staat niet op de kaart", "submitSingular": "Meld dit lichtpunt", "unregisteredId": "Nummer van het lichtpunt", "objectTypePlural": "lichtpunten", "objectTypeSingular": "lichtpunt"}, "shortLabel": "Lichtpunt(en) op kaart", "featureTypes": [{"icon": {"iconUrl": "/assets/images/icon-reported-marker.svg"}, "label": "Is gemeld", "idField": "OBJECTID", "typeField": "IS_GEMELD", "typeValue": "1", "description": "Is gemeld {{ MASTNUMMER }}"}, {"icon": {"iconUrl": "/assets/images/openbare_verlichting/overig.svg"}, "type": "Lichtmast", "idField": "OBJECTID", "typeField": "SOORTOBJECT", "description": "Lichtpunt {{ MASTNUMMER }}"}, {"icon": {"iconUrl": "/assets/images/featureUnknownMarker.svg"}, "label": "Onbekend", "idField": "OBJECTID", "typeField": "SOORTOBJECT", "typeValue": "not-on-map", "description": "Het lichtpunt staat niet op de kaart"}]}</td></tr><tr><td>LocationSelect</td><td>{"label": "Waar is het?", "language": {"title": "Locatie", "submit": "Gebruik deze locatie", "subTitle": "Waar is het?", "description": "Typ het dichtstbijzijnde adres of klik de locatie aan op de kaart"}, "shortLabel": "Waar is het?", "featureTypes": []}</td></tr></tbody></table>
