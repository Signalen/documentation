...
MOON is een aannemer van (onder andere) openbare verlichting, schakelkasten en putten.
...
MOON heeft in 2026 een tool gebouwd. Gemeente kunnen dan zelf bepalen welke status de melding in Signalen krijgt wanneer de status in MOON wijzigt. Daarnaast kan ingesteld worden welke tekst naar Signalen moet, bijvoorbeeld om het KCC van de meest recente informatie te voorzien. Ook kan ingesteld worden dat er een bericht naar de melder moet gaan en welk bericht (via Signalen) moet worden verstuurd.
